...
import { addAccessData, addClassData, getAllPeriods, getAllPeriodsChart, getAllPeriodsReport, getPeriodsByTeacher } from '../controller/periodController.js'
...
router.get('/chart', authenticateAdmin, getAllPeriodsChart)

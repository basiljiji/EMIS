...
import { useAddFixtureMutation, useDeleteFixtureMutation, useGetFixturesQuery } from "../slices/fixturesApiSlice"
...
const Dashboard = () => {
    ...
    const [deleteFixture, { isLoading: loadingDelete }] = useDeleteFixtureMutation()
